...
export class VillagemeetingRbkComponent implements OnInit {
  ...
  onRbkChange(result): void {
    this.router.navigate(['/jcLevel/villageLevelMeetingsVillageLevelReport'], {
      queryParams: { request: result },
    });
  }

  onFunctionariesClickChange(result): void {
    this.router.navigate(['/jcLevel/VillagemeetingFunctionariesReport'], {
      queryParams: { request: result },
    });
  }

  onSecAssSecClickChange(result): void {
    this.router.navigate(['/jcLevel/VillagemeetingSecAndAssSecReport'], {
      queryParams: { request: result },
    });
  }

  onBuildingInspectClickChange(result): void {
    this.router.navigate(['/jcLevel/VillagemeetingBuildingInsReport'], {
      queryParams: { request: result },
    });
  }

  onCalibrationClickChange(result): void {
    this.router.navigate(['/jcLevel/VillagemeetingCalibrationReport'], {
      queryParams: { request: result },
    });
  }

  onPromotersClickChange(result): void {
    this.router.navigate(['/jcLevel/VillagemeetingPromotersReport'], {
      queryParams: { request: result },
    });
  }
  ...
  btnBack(): void {
    ...
    this.router.navigate(['/jcLevel/villageLevelMeetingsMentorLevelReport'], {
      queryParams: { request: result },
    });
  }
}
