...
export class FarmerBankBAUStatusRbkReportComponent implements OnInit {
  ...
  onInvalidAccChange(result): void {
    this.router.navigate(['/jcLevel/FarmerBankInvalidAccountsReport'], {
  ...
  onVerifiedApprovedRejectedChange(result): void {
    this.router.navigate(
      ['/jcLevel/FarmerBankVerifiedAcceptedRejectedReport'],
      {
        queryParams: { request: result },
      }
    );
  ...
  onPendingAtDAChange(result): void {
    this.router.navigate(['/jcLevel/FarmerBankPendingAtDaReport'], {
      queryParams: { request: result },
    });
  }

  onPendingAtMentorChange(result): void {
    this.router.navigate(['/jcLevel/FarmerBankPendingAtMentorReport'], {
      queryParams: { request: result },
    });
  }
  ...
  btnBack(): void {
    ...
    this.router.navigate(['/jcLevel/FarmerBankBAUStatusMandalReport'], {
      queryParams: { request: result },
    });
  }
}
