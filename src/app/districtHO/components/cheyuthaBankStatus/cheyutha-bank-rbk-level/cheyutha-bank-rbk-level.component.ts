...
export class CheyuthaBankRbkLevelComponent implements OnInit {
  ...
  onPendingChange(result): void {
    this.router.navigate(['/districtHO/CheyuthaBankPendingReport'], {
      queryParams: { request: result },
    });
  }

  onApprovedChange(result): void {
    this.router.navigate(['/districtHO/CheyuthaBankAcceptedReport'], {
      queryParams: { request: result },
    });
  }

  onRejectedChange(result): void {
    this.router.navigate(['/districtHO/CheyuthaBankRejectedReport'], {
      queryParams: { request: result },
    });
  }
  ...
  btnBack(): void {
    ...
    this.router.navigate(['/districtHO/CheyuthaBankMandalLevelReport'], {
      queryParams: { request: result },
    });
  }
}
