...
export class VillagemeetingRbkComponent implements OnInit {
  ...
  onRbkChange(result): void {
    this.router.navigate(
      ['/districtHO/villageLevelMeetingsVillageLevelReport'],
      {
  ...
  onFunctionariesClickChange(result): void {
    this.router.navigate(['/districtHO/VillagemeetingFunctionariesReport'], {
      queryParams: { request: result },
    });
  }

  onSecAssSecClickChange(result): void {
    this.router.navigate(['/districtHO/VillagemeetingSecAndAssSecReport'], {
      queryParams: { request: result },
    });
  }

  onBuildingInspectClickChange(result): void {
    this.router.navigate(['/districtHO/VillagemeetingBuildingInsReport'], {
      queryParams: { request: result },
    });
  }

  onCalibrationClickChange(result): void {
    this.router.navigate(['/districtHO/VillagemeetingCalibrationReport'], {
      queryParams: { request: result },
    });
  }

  onPromotersClickChange(result): void {
    this.router.navigate(['/districtHO/VillagemeetingPromotersReport'], {
      queryParams: { request: result },
    });
  }
  ...
  btnBack(): void {
    ...
    this.router.navigate(
      ['/districtHO/villageLevelMeetingsMentorLevelReport'],
      {
        queryParams: { request: result },
      }
    );
