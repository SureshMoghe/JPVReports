...
export class FarmerBankBAUStatusRbkReportComponent implements OnInit {
  ...
  onInvalidAccChange(result): void {
    this.router.navigate(['/districtHO/FarmerBankInvalidAccountsReport'], {
  ...
  onVerifiedApprovedRejectedChange(result): void {
    this.router.navigate(
      ['/districtHO/FarmerBankVerifiedAcceptedRejectedReport'],
      {
        queryParams: { request: result },
      }
    );
  ...
  onPendingAtDAChange(result): void {
    this.router.navigate(['/districtHO/FarmerBankPendingAtDaReport'], {
      queryParams: { request: result },
    });
  }

  onPendingAtMentorChange(result): void {
    this.router.navigate(['/districtHO/FarmerBankPendingAtMentorReport'], {
      queryParams: { request: result },
    });
  }
  ...
  btnBack(): void {
    ...
    this.router.navigate(['/districtHO/FarmerBankBAUStatusMandalReport'], {
      queryParams: { request: result },
    });
  }
}
