...
export class AmcuHandingOverRbkReportComponent implements OnInit {
  ...
  onRbkChange(result): void {
    this.router.navigate(['/seLevel/AmcuHandingOverDetailReport'], {
      queryParams: { request: result },
    });
  }

  onVillageChange(result): void {
    this.router.navigate(['/seLevel/AmcuHoNotSubmittedVillagesReport'], {
      queryParams: { request: result },
    });
  }
  ...
  btnBack(): void {
    ...
    this.router.navigate(['/seLevel/AmcuHandingOverMentorReport'], {
      queryParams: { request: result },
    });
  }
}
