...
@Component({
  selector: 'app-session-wise-milk-pouring-mentor-level-report',
  templateUrl: './session-wise-milk-pouring-mentor-level-report.component.html',
  styleUrls: ['./session-wise-milk-pouring-mentor-level-report.component.css']
})
export class SessionWiseMilkPouringMentorLevelReportComponent implements OnInit {
  input: any;
  districtId: any;
  districtName: any;
  mentorId: any;
  ...
  onRbkChange(result): void {
    this.router.navigate(['/state/SessionWiseMilkPouringRBKLevelReport'], {
