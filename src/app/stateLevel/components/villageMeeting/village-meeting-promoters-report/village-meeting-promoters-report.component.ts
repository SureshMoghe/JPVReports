...
@Component({
  selector: 'app-village-meeting-promoters-report',
  templateUrl: './village-meeting-promoters-report.component.html',
  styleUrls: ['./village-meeting-promoters-report.component.css'],
})
