...
@Component({
  selector: 'app-mdssrbkdetails',
  templateUrl: './mdssrbkdetails.component.html',
  styleUrls: ['./mdssrbkdetails.component.css']
})
export class MDSSRBKDetailsComponent implements OnInit {
