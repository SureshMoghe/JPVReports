...
@Component({
  selector: 'app-statecheyutha-jpv-registeredfarmerount',
  templateUrl: './statecheyutha-jpv-registeredfarmerount.component.html',
  styleUrls: ['./statecheyutha-jpv-registeredfarmerount.component.css']
})
export class StatecheyuthaJpvRegisteredfarmerountComponent implements OnInit, OnDestroy, AfterViewInit {  
  distmanrbk:any;
  input: any;
  districtId: any;
  districtName: any;
