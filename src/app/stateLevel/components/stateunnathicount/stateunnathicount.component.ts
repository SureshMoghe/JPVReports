...
@Component({
  selector: 'app-stateunnathicount',
  templateUrl: './stateunnathicount.component.html',
  styleUrls: ['./stateunnathicount.component.css']
})
export class StateunnathicountComponent implements OnInit {
