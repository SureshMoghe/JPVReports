...
@Component({
  selector: 'app-statebanklinkcount',
  templateUrl: './statebanklinkcount.component.html',
  styleUrls: ['./statebanklinkcount.component.css']
})
export class StatebanklinkcountComponent implements OnInit {
  ...
  btnExcel(): void {
    this.utils.JSONToCSVConvertor(
      this.excelData,
      'Bank Linkage Beneficiaries Report',
      true
    );
  }
  btnBack(): void { 
