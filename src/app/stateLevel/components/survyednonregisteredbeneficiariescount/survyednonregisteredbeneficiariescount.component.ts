...
@Component({
  selector: 'app-survyednonregisteredbeneficiariescount',
  templateUrl: './survyednonregisteredbeneficiariescount.component.html',
  styleUrls: ['./survyednonregisteredbeneficiariescount.component.css']
})
export class SurvyednonregisteredbeneficiariescountComponent implements OnInit, OnDestroy, AfterViewInit { 
