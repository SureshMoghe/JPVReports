...
@Component({
  selector: 'app-state-total-cheyutha-beneficiaries-groundedwithanimalscount',
  templateUrl: './state-total-cheyutha-beneficiaries-groundedwithanimalscount.component.html',
  styleUrls: ['./state-total-cheyutha-beneficiaries-groundedwithanimalscount.component.css']
})
export class StateTotalCheyuthaBeneficiariesGroundedwithanimalscountComponent implements OnInit, OnDestroy, AfterViewInit { 
        ...
        //   );
          let singleRow = {
            ...
            DISTRICT_NAME: this.routeListDetails[i].DISTRICT_NAME,
               ...
               BENEFICIARY_NAME: this.routeListDetails[i].BENEFICIARY_NAME,
               BENEFICIARY_AADHAR: this.routeListDetails[i].BENEFICIARY_AADHAR,
               BENEFICIARY_MOBILE: this.routeListDetails[i].BENEFICIARY_MOBILE,
