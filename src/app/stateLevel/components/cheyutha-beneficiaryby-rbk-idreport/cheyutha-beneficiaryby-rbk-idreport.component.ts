...
@Component({
  selector: 'app-cheyutha-beneficiaryby-rbk-idreport',
  templateUrl: './cheyutha-beneficiaryby-rbk-idreport.component.html',
  styleUrls: ['./cheyutha-beneficiaryby-rbk-idreport.component.css']
})
export class CheyuthaBeneficiarybyRbkIDReportComponent implements OnInit {
