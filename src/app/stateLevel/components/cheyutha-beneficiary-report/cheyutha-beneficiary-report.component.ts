...
@Component({ 
  selector: 'app-cheyutha-beneficiary-report',
  templateUrl: './cheyutha-beneficiary-report.component.html',
  styleUrls: ['./cheyutha-beneficiary-report.component.css']
})
export class CheyuthaBeneficiaryReportComponent implements OnInit, OnDestroy, AfterViewInit {
  input: any;
  ID:any;
