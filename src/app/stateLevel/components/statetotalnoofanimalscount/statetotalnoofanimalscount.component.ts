...
@Component({
  selector: 'app-statetotalnoofanimalscount',
  templateUrl: './statetotalnoofanimalscount.component.html',
  styleUrls: ['./statetotalnoofanimalscount.component.css']
})
export class StatetotalnoofanimalscountComponent implements OnInit {
