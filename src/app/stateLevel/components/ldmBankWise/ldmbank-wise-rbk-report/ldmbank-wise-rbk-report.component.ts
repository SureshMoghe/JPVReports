...
export class LdmbankWiseRbkReportComponent implements OnInit {
  ...
  onPendingChange(result): void {
    this.router.navigate(['/state/LdmbankWisePendingReport'], {
      queryParams: { request: result },
    });
  }

  onApprovedRejectedChange(result): void {
    this.router.navigate(['/state/LdmbankWiseApprovedRejectedReport'], {
      queryParams: { request: result },
    });
  }
  ...
  btnBack(): void {
    ...
    this.router.navigate(['/state/LdmbankWiseBranchReport'], {
      queryParams: { request: result },
    });
  }
}
