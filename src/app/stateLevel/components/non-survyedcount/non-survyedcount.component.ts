...
@Component({
  selector: 'app-non-survyedcount',
  templateUrl: './non-survyedcount.component.html',
  styleUrls: ['./non-survyedcount.component.css']
})
export class NonSurvyedcountComponent implements OnInit, OnDestroy, AfterViewInit { 
