...
@Component({
  selector: 'app-statenoncheyuthabene-regjpvfarmer-changegroundanimalcount',
  templateUrl: './statenoncheyuthabene-regjpvfarmer-changegroundanimalcount.component.html',
  styleUrls: ['./statenoncheyuthabene-regjpvfarmer-changegroundanimalcount.component.css']
})
export class StatenoncheyuthabeneRegjpvfarmerChangegroundanimalcountComponent implements  OnInit, OnDestroy, AfterViewInit  { 
