...
@Component({
  selector: 'app-society-abstract-report',
  templateUrl: './society-abstract-report.component.html',
  styleUrls: ['./society-abstract-report.component.css'],
})
export class SocietyAbstractReportComponent
