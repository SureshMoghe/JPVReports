...
@Component({
  selector: 'app-surveyed-without-animalscount',
  templateUrl: './surveyed-without-animalscount.component.html',
  styleUrls: ['./surveyed-without-animalscount.component.css']
})
export class SurveyedWithoutAnimalscountComponent implements OnInit, OnDestroy, AfterViewInit { 
