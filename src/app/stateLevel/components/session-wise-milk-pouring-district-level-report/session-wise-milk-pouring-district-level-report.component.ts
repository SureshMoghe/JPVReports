...
@Component({
  selector: 'app-session-wise-milk-pouring-district-level-report',
  templateUrl: './session-wise-milk-pouring-district-level-report.component.html',
  styleUrls: ['./session-wise-milk-pouring-district-level-report.component.css']
})
export class SessionWiseMilkPouringDistrictLevelReportComponent implements OnInit {
  input: any;
  districtId: any;
  districtName: any;
  fromDate: any;
  ...
  btnBack(): void {
    this.router.navigate(['/state/SessionWiseMilkPouringStateLevelReport']);
  }
}
