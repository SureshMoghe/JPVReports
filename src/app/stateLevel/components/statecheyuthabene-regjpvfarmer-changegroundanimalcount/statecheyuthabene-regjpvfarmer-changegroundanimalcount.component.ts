...
@Component({
  selector: 'app-statecheyuthabene-regjpvfarmer-changegroundanimalcount',
  templateUrl: './statecheyuthabene-regjpvfarmer-changegroundanimalcount.component.html',
  styleUrls: ['./statecheyuthabene-regjpvfarmer-changegroundanimalcount.component.css']
})
export class StatecheyuthabeneRegjpvfarmerChangegroundanimalcountComponent implements OnInit, OnDestroy, AfterViewInit { 
