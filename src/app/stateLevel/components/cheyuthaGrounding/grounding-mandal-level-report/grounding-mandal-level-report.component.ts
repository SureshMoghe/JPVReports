...
export class GroundingMandalLevelReportComponent implements OnInit {
  ...
  constructor(private utils: UtilsService, private route: ActivatedRoute,private router: Router, private logger: LoggerService) {
  ...
  onDetailChange(result): void {
    this.router.navigate(['/state/GroundingDetailLevelReport'], {
