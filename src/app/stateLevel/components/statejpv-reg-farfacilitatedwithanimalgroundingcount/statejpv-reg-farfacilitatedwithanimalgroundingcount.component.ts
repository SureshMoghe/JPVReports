...
@Component({
  selector: 'app-statejpv-reg-farfacilitatedwithanimalgroundingcount',
  templateUrl: './statejpv-reg-farfacilitatedwithanimalgroundingcount.component.html',
  styleUrls: ['./statejpv-reg-farfacilitatedwithanimalgroundingcount.component.css']
})
export class StatejpvRegFarfacilitatedwithanimalgroundingcountComponent implements  OnInit, OnDestroy, AfterViewInit {
