...
@Component({
  selector: 'app-daily-bargraph-society-abstract-report',
  templateUrl: './daily-bargraph-society-abstract-report.component.html',
  styleUrls: ['./daily-bargraph-society-abstract-report.component.css']
})
export class DailyBargraphSocietyAbstractReportComponent implements OnInit, OnDestroy, AfterViewInit
{
  ...
  btntotalsocieties(): void { 
    ...
    // const result = this.utils.encrypt(JSON.stringify(requestData));
     this.router.navigate(['/state/MilkpouredandpendingSocietiesReport']);
   }
   btnDashboard(): void { 
  ...
  btnPendingVillageDetailsReport(): void {
try {
  ...
  btnPendingSocietiesDetailsReport(): void {
    try {
