...
@Component({
    selector: 'app-mandal-no-of-women-farmer-milk-pouring-grid-list',
    templateUrl: './mandal-no-of-women-farmer-milk-pouring-grid-list.component.html',
    styleUrls: ['./mandal-no-of-women-farmer-milk-pouring-grid-list.component.css']
})
export class MandalNoOfWomenFarmerMilkPouringGridListComponent implements OnInit {
        ...
        try {
            ...
            if (res.success) {
                ...
                for (let i = 0; i < this.milkPouringDetails.length; i++) {
                    ...
                    let singleRow = {
                        S_No: i + 1,
                        Mandals: this.milkPouringDetails[i].MANDAL_NAME,
