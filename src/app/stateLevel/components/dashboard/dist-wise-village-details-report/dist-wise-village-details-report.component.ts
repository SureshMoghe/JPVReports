...
@Component({
    selector: 'app-dist-wise-village-details-report',
    templateUrl: './dist-wise-village-details-report.component.html',
    styleUrls: ['./dist-wise-village-details-report.component.css']
})
export class DistWiseVillageDetailsReportComponent implements OnInit {
