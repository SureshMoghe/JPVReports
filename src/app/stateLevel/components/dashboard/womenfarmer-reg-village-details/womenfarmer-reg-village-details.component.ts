...
@Component({
    selector: 'app-womenfarmer-reg-village-details',
    templateUrl: './womenfarmer-reg-village-details.component.html',
    styleUrls: ['./womenfarmer-reg-village-details.component.css']
})
export class WomenfarmerRegVillageDetailsComponent implements OnInit {
        ...
        try {
            ...
            if (res.success) {
                ...
                for (let i = 0; i < this.dailyRegisteredFarmersDetails.length; i++) {
                    ...
                    let singleRow = {
                        S_No: i + 1,
                        Villages: this.dailyRegisteredFarmersDetails[i].VILLAGE_NAME,
