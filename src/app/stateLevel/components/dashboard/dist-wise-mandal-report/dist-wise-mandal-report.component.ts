...
@Component({
    selector: 'app-dist-wise-mandal-report',
    templateUrl: './dist-wise-mandal-report.component.html',
    styleUrls: ['./dist-wise-mandal-report.component.css']
})
export class DistWiseMandalReportComponent implements OnInit {
