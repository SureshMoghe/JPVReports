...
@Component({
    selector: 'app-dist-wise-mandal-details-report',
    templateUrl: './dist-wise-mandal-details-report.component.html',
    styleUrls: ['./dist-wise-mandal-details-report.component.css']
})
export class DistWiseMandalDetailsReportComponent implements OnInit {
