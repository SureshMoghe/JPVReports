...
@Component({
    selector: 'app-rbkwise-details',
    templateUrl: './rbkwise-details.component.html',
    styleUrls: ['./rbkwise-details.component.css']
})
export class RbkwiseDetailsComponent implements OnInit {
