...
@Component({
  selector: 'app-pending-societies-details',
  templateUrl: './pending-societies-details.component.html',
  styleUrls: ['./pending-societies-details.component.css'] 
})
export class PendingSocietiesDetailsComponent implements OnInit, OnDestroy, AfterViewInit
{
