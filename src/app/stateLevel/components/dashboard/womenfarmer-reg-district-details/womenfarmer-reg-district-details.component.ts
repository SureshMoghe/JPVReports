...
@Component({
    selector: 'app-womenfarmer-reg-district-details',
    templateUrl: './womenfarmer-reg-district-details.component.html',
    styleUrls: ['./womenfarmer-reg-district-details.component.css']
})
export class WomenfarmerRegDistrictDetailsComponent implements OnInit, OnDestroy, AfterViewInit {
