...
@Component({
    selector: 'app-village-wise-rbk-grid-report',
    templateUrl: './village-wise-rbk-grid-report.component.html',
    styleUrls: ['./village-wise-rbk-grid-report.component.css']
})
export class VillageWiseRbkGridReportComponent implements OnInit {
