...
@Component({
  selector: 'app-pending-village-details',
  templateUrl: './pending-village-details.component.html',
  styleUrls: ['./pending-village-details.component.css']
})
export class PendingVillageDetailsComponent implements OnInit, OnDestroy, AfterViewInit
{
  ...
  btnGetDetails(obj): void {debugger;
   ...
   this.router.navigate(['/state/PendingVillageReport'], {   queryParams: { request: encryptedString },  });
