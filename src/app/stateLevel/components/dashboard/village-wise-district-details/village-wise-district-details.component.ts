...
@Component({
    selector: 'app-village-wise-district-details',
    templateUrl: './village-wise-district-details.component.html',
    styleUrls: ['./village-wise-district-details.component.css']
})
export class VillageWiseDistrictDetailsComponent implements OnInit, OnDestroy, AfterViewInit {
