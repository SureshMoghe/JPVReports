...
@Component({
  selector: 'app-pending-village-information',
  templateUrl: './pending-village-information.component.html',
  styleUrls: ['./pending-village-information.component.css']
})
export class PendingVillageInformationComponent implements OnInit {
  @Input() VILLAGECODE: any; 
