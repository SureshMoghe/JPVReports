...
@Component({
    selector: 'app-dist-wise-district-details-report',
    templateUrl: './dist-wise-district-details-report.component.html',
    styleUrls: ['./dist-wise-district-details-report.component.css']
})
export class DistWiseDistrictDetailsReportComponent implements OnInit {
