...
@Component({
    selector: 'app-villagewise-report',
    templateUrl: './villagewise-report.component.html',
    styleUrls: ['./villagewise-report.component.css']
})
export class VillagewiseReportComponent implements OnInit {
    Selected_Date: any;
    input: any;
    RbkId: any;
    MandalName: any;
    ...
    onVillageChange(result) {
        debugger;
        this.router.navigate(['/state/FarmerwiseReport'], {// DistrictWiseFarmerReport
