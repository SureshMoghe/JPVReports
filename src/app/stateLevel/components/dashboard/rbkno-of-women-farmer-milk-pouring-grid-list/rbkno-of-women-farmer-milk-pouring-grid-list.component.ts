...
@Component({
    selector: 'app-rbkno-of-women-farmer-milk-pouring-grid-list',
    templateUrl: './rbkno-of-women-farmer-milk-pouring-grid-list.component.html',
    styleUrls: ['./rbkno-of-women-farmer-milk-pouring-grid-list.component.css']
})
export class RBKNoOfWomenFarmerMilkPouringGridListComponent implements OnInit {
        ...
        try {
            ...
            if (res.success) {
                ...
                for (let i = 0; i < this.milkPouringDetails.length; i++) {
                    ...
                    let singleRow = {
                        S_No: i + 1,
                        RBKs: this.milkPouringDetails[i].RBK_NAME,
