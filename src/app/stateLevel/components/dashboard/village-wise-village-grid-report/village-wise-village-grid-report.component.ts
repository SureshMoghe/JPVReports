...
@Component({
    selector: 'app-village-wise-village-grid-report',
    templateUrl: './village-wise-village-grid-report.component.html',
    styleUrls: ['./village-wise-village-grid-report.component.css']
})
export class VillageWiseVillageGridReportComponent implements OnInit {
