...
@Component({
    selector: 'app-dist-wise-rbk-details-report',
    templateUrl: './dist-wise-rbk-details-report.component.html',
    styleUrls: ['./dist-wise-rbk-details-report.component.css']
})
export class DistWiseRbkDetailsReportComponent implements OnInit {
