...
@Component({
    selector: 'app-noof-rbk-count-details',
    templateUrl: './noof-rbk-count-details.component.html',
    styleUrls: ['./noof-rbk-count-details.component.css']
})
export class NoofRbkCountDetailsComponent implements OnInit, OnDestroy, AfterViewInit {
