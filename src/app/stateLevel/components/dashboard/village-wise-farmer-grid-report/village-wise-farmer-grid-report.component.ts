...
@Component({
    selector: 'app-village-wise-farmer-grid-report',
    templateUrl: './village-wise-farmer-grid-report.component.html',
    styleUrls: ['./village-wise-farmer-grid-report.component.css']
})
export class VillageWiseFarmerGridReportComponent implements OnInit {
