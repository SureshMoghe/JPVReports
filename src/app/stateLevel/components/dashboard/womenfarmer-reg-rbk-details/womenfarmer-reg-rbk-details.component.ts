...
@Component({
    selector: 'app-womenfarmer-reg-rbk-details',
    templateUrl: './womenfarmer-reg-rbk-details.component.html',
    styleUrls: ['./womenfarmer-reg-rbk-details.component.css']
})
export class WomenfarmerRegRbkDetailsComponent implements OnInit {
        ...
        try {
            ...
            if (res.success) {
                ...
                for (let i = 0; i < this.dailyRegisteredFarmersDetails.length; i++) {
                    ...
                    let singleRow = {
                        S_No: i + 1,
                        RBKs: this.dailyRegisteredFarmersDetails[i].RBK_NAME,
