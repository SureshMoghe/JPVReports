...
@Component({
  selector: 'app-cheyutha-rbkbymandalid-reports',
  templateUrl: './cheyutha-rbkbymandalid-reports.component.html',
  styleUrls: ['./cheyutha-rbkbymandalid-reports.component.css']
})
export class CheyuthaRbkbymandalidReportsComponent  implements OnInit { 
