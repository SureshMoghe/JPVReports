...
@Component({
  selector: 'app-surveyed-with-animalscount',
  templateUrl: './surveyed-with-animalscount.component.html',
  styleUrls: ['./surveyed-with-animalscount.component.css']
})
export class SurveyedWithAnimalscountComponent implements OnInit, OnDestroy, AfterViewInit { 
