...
@Component({
  selector: 'app-statecheyuthabeneficiariescount',
  templateUrl: './statecheyuthabeneficiariescount.component.html',
  styleUrls: ['./statecheyuthabeneficiariescount.component.css']
})
export class StatecheyuthabeneficiariescountComponent implements OnInit, OnDestroy, AfterViewInit {
