...
export class FarmerBankBAUStatusRbkReportComponent implements OnInit {
  ...
  onInvalidAccChange(result): void {
    this.router.navigate(['/dcLevel/FarmerBankInvalidAccountsReport'], {
  ...
  onVerifiedApprovedRejectedChange(result): void {
    this.router.navigate(
      ['/dcLevel/FarmerBankVerifiedAcceptedRejectedReport'],
      {
        queryParams: { request: result },
      }
    );
  ...
  onPendingAtDAChange(result): void {
    this.router.navigate(['/dcLevel/FarmerBankPendingAtDaReport'], {
      queryParams: { request: result },
    });
  }

  onPendingAtMentorChange(result): void {
    this.router.navigate(['/dcLevel/FarmerBankPendingAtMentorReport'], {
      queryParams: { request: result },
    });
  }
  ...
  btnBack(): void {
    ...
    this.router.navigate(['/dcLevel/FarmerBankBAUStatusMandalReport'], {
      queryParams: { request: result },
    });
  }
}
