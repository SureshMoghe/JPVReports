...
@Component({
  selector: 'app-villagemeeting-attendance',
  templateUrl: './villagemeeting-attendance.component.html',
  styleUrls: ['./villagemeeting-attendance.component.css'],
})
export class VillagemeetingAttendanceComponent implements OnInit {
  input: any;
  districtId: any;
  districtName: any;
  mentorId: any;
