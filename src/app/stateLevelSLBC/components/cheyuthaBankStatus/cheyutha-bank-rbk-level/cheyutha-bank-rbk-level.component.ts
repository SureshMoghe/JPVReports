...
export class CheyuthaBankRbkLevelComponent implements OnInit {
  ...
  onPendingChange(result): void {
    this.router.navigate(['/stateLevelSLBC/CheyuthaBankPendingReport'], {
      queryParams: { request: result },
    });
  }

  onApprovedChange(result): void {
    this.router.navigate(['/stateLevelSLBC/CheyuthaBankAcceptedReport'], {
      queryParams: { request: result },
    });
  }

  onRejectedChange(result): void {
    this.router.navigate(['/stateLevelSLBC/CheyuthaBankRejectedReport'], {
      queryParams: { request: result },
    });
  }
