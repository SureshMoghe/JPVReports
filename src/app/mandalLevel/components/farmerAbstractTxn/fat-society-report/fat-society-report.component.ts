...
@Component({
  selector: 'app-fat-society-report',
  templateUrl: './fat-society-report.component.html',
  styleUrls: ['./fat-society-report.component.css']
})
export class FatSocietyReportComponent implements OnInit {
  input: any;
  districtId: any;
  districtName: any;
  mandalId: any;
