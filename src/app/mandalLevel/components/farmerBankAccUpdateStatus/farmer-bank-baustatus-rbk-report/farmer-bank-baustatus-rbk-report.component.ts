...
export class FarmerBankBAUStatusRbkReportComponent implements OnInit {
  ...
  onInvalidAccChange(result): void {
    this.router.navigate(['/mandalLevel/FarmerBankInvalidAccountsReport'], {
      queryParams: { request: result },
    });
  }

  onVerifiedApprovedRejectedChange(result): void {
    this.router.navigate(['/mandalLevel/FarmerBankVerifiedAcceptedRejectedReport'], {
      queryParams: { request: result },
    });
  }

  onPendingAtDAChange(result): void {
    this.router.navigate(['/mandalLevel/FarmerBankPendingAtDaReport'], {
      queryParams: { request: result },
    });
  }

  onPendingAtMentorChange(result): void {
    this.router.navigate(['/mandalLevel/FarmerBankPendingAtMentorReport'], {
      queryParams: { request: result },
    });
  }
  ...
  btnBack(): void {
    ...
    this.router.navigate(['/mandalLevel/FarmerBankBAUStatusMandalReport'], {
      queryParams: { request: result },
    });
  }
}
