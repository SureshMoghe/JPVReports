...
@Component({
  selector: 'app-loan-sanction-and-grounding',
  templateUrl: './loan-sanction-and-grounding.component.html',
  styleUrls: ['./loan-sanction-and-grounding.component.css'],
})
export class LoanSanctionAndGroundingComponent
