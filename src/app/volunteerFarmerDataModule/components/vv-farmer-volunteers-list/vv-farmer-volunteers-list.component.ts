...
@Component({
  selector: 'app-vv-farmer-volunteers-list',
  templateUrl: './vv-farmer-volunteers-list.component.html',
  styleUrls: ['./vv-farmer-volunteers-list.component.css'],
})
export class VvFarmerVolunteersListComponent
  ...
  async loadReport(): Promise<void> {
    try {
      ...
      this.spinner.show();
      const res = await this.vvFarmerAPI.totalVolunteersList(req);
      if (res.success) {
        this.excelData = [];
