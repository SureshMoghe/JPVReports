...
@Component({
  selector: 'app-dccb-survyednonregisteredbeneficiariescount',
  templateUrl: './dccb-survyednonregisteredbeneficiariescount.component.html',
  styleUrls: ['./dccb-survyednonregisteredbeneficiariescount.component.css']
})
export class DccbSurvyednonregisteredbeneficiariescountComponent implements OnInit, OnDestroy, AfterViewInit { 
        ...
        //   );
          let singleRow = {
            ...
            DISTRICT_NAME: this.routeListDetails[i].DISTRICT_NAME,
               ...
               SURVEDYEDSTATUS: this.routeListDetails[i].STATUS,   
