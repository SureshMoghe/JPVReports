...
@Component({
  selector: 'app-dccb-survyed-regfarmerscount',
  templateUrl: './dccb-survyed-regfarmerscount.component.html',
  styleUrls: ['./dccb-survyed-regfarmerscount.component.css']
})
export class DccbSurvyedRegfarmerscountComponent implements OnInit, OnDestroy, AfterViewInit { 
