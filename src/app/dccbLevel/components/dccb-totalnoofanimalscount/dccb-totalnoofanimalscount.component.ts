...
@Component({
  selector: 'app-dccb-totalnoofanimalscount',
  templateUrl: './dccb-totalnoofanimalscount.component.html',
  styleUrls: ['./dccb-totalnoofanimalscount.component.css']
})
export class DccbTotalnoofanimalscountComponent implements OnInit {
