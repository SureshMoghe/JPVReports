...
@Component({
  selector: 'app-dccb-cheyutha-beneficiaries-count',
  templateUrl: './dccb-cheyutha-beneficiaries-count.component.html',
  styleUrls: ['./dccb-cheyutha-beneficiaries-count.component.css']
})
export class DccbCheyuthaBeneficiariesCountComponent implements OnInit, OnDestroy, AfterViewInit {
