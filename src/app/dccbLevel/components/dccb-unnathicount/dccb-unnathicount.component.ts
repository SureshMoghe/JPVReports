...
@Component({
  selector: 'app-dccb-unnathicount',
  templateUrl: './dccb-unnathicount.component.html',
  styleUrls: ['./dccb-unnathicount.component.css']
})
export class DccbUnnathicountComponent implements OnInit {
