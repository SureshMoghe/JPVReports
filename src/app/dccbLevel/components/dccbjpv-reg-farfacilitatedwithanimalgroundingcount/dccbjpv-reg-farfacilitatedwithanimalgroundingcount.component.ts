...
@Component({
  selector: 'app-dccbjpv-reg-farfacilitatedwithanimalgroundingcount',
  templateUrl: './dccbjpv-reg-farfacilitatedwithanimalgroundingcount.component.html',
  styleUrls: ['./dccbjpv-reg-farfacilitatedwithanimalgroundingcount.component.css']
})
export class DccbjpvRegFarfacilitatedwithanimalgroundingcountComponent implements  OnInit, OnDestroy, AfterViewInit {
