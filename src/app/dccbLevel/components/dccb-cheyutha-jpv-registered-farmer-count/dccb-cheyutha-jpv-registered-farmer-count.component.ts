...
@Component({
  selector: 'app-dccb-cheyutha-jpv-registered-farmer-count',
  templateUrl: './dccb-cheyutha-jpv-registered-farmer-count.component.html',
  styleUrls: ['./dccb-cheyutha-jpv-registered-farmer-count.component.css']
})
export class DccbCheyuthaJpvRegisteredFarmerCountComponent implements OnInit, OnDestroy, AfterViewInit {  
  distmanrbk:any;
  input: any;
  districtId: any;
  districtName: any;
      ...
      if (res.success) {
        ...
        //   );
          let singleRow = {
            ...
            MOBILE_NUMBER: this.routeListDetails[i]
              .MOBILE_NUMBER,
              SOCIETY_CODE: this.routeListDetails[i].SOCIETY_CODE,
              SOCIETY_NAME: this.routeListDetails[i]
              .SOCIETY_NAME,
