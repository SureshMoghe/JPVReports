...
@Component({
  selector: 'app-dccb-total-cheyutha-beneficiaries-groundedwithanimalscount',
  templateUrl: './dccb-total-cheyutha-beneficiaries-groundedwithanimalscount.component.html',
  styleUrls: ['./dccb-total-cheyutha-beneficiaries-groundedwithanimalscount.component.css']
})
export class DccbTotalCheyuthaBeneficiariesGroundedwithanimalscountComponent implements OnInit, OnDestroy, AfterViewInit { 
