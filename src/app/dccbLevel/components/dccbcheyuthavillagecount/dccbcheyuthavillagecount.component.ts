...
@Component({
  selector: 'app-dccbcheyuthavillagecount',
  templateUrl: './dccbcheyuthavillagecount.component.html',
  styleUrls: ['./dccbcheyuthavillagecount.component.css']
})
export class DccbcheyuthavillagecountComponent implements OnInit {
