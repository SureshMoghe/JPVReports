...
@Component({
  selector: 'app-dccb-streenidhicount',
  templateUrl: './dccb-streenidhicount.component.html',
  styleUrls: ['./dccb-streenidhicount.component.css']
})
export class DccbStreenidhicountComponent implements OnInit {
