...
@Component({
  selector: 'app-dccb-surveyed-without-animalscount',
  templateUrl: './dccb-surveyed-without-animalscount.component.html',
  styleUrls: ['./dccb-surveyed-without-animalscount.component.css']
})
export class DccbSurveyedWithoutAnimalscountComponent implements OnInit, OnDestroy, AfterViewInit { 
