...
@Component({
  selector: 'app-dccb-surveyed-with-animalscount',
  templateUrl: './dccb-surveyed-with-animalscount.component.html',
  styleUrls: ['./dccb-surveyed-with-animalscount.component.css']
})
export class DccbSurveyedWithAnimalscountComponent implements OnInit, OnDestroy, AfterViewInit { 
