...
@Component({
  selector: 'app-dccb-banklinkcount',
  templateUrl: './dccb-banklinkcount.component.html',
  styleUrls: ['./dccb-banklinkcount.component.css']
})
export class DccbBanklinkcountComponent implements OnInit {
