...
@Component({
  selector: 'app-dccb-cheyuthabene-regjpvfarmer-changegroundanimalcount',
  templateUrl: './dccb-cheyuthabene-regjpvfarmer-changegroundanimalcount.component.html',
  styleUrls: ['./dccb-cheyuthabene-regjpvfarmer-changegroundanimalcount.component.css']
})
export class DccbCheyuthabeneRegjpvfarmerChangegroundanimalcountComponent implements OnInit, OnDestroy, AfterViewInit { 
