...
@Component({
  selector: 'app-mdac-not-created-rbk-list',
  templateUrl: './mdac-not-created-rbk-list.component.html',
  styleUrls: ['./mdac-not-created-rbk-list.component.css'],
})
export class MdacNotCreatedRbkListComponent
  ...
  async loadReport(): Promise<void> {
    try {
      ...
      this.spinner.show();
      const res = await this.bankAccAPI.mdacNotCreatedRbkList(req);
      if (res.success) {
        this.excelData = [];
