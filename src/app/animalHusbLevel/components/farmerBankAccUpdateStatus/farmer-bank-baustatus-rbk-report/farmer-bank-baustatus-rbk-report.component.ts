...
export class FarmerBankBAUStatusRbkReportComponent implements OnInit {
  ...
  onInvalidAccChange(result): void {
    this.router.navigate(['/animalHusbLevel/FarmerBankInvalidAccountsReport'], {
  ...
  onVerifiedApprovedRejectedChange(result): void {
    this.router.navigate(
      ['/animalHusbLevel/FarmerBankVerifiedAcceptedRejectedReport'],
      {
        queryParams: { request: result },
      }
    );
  ...
  onPendingAtDAChange(result): void {
    this.router.navigate(['/animalHusbLevel/FarmerBankPendingAtDaReport'], {
      queryParams: { request: result },
    });
  }

  onPendingAtMentorChange(result): void {
    this.router.navigate(['/animalHusbLevel/FarmerBankPendingAtMentorReport'], {
      queryParams: { request: result },
    });
  }
}
