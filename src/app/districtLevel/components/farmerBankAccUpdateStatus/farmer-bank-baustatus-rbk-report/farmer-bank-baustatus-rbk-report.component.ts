...
export class FarmerBankBAUStatusRbkReportComponent implements OnInit {
  ...
  onInvalidAccChange(result): void {
    this.router.navigate(['/district/FarmerBankInvalidAccountsReport'], {
  ...
  onVerifiedApprovedRejectedChange(result): void {
    this.router.navigate(
      ['/district/FarmerBankVerifiedAcceptedRejectedReport'],
      {
        queryParams: { request: result },
      }
    );
  ...
  onPendingAtDAChange(result): void {
    this.router.navigate(['/district/FarmerBankPendingAtDaReport'], {
      queryParams: { request: result },
    });
  }

  onPendingAtMentorChange(result): void {
    this.router.navigate(['/district/FarmerBankPendingAtMentorReport'], {
      queryParams: { request: result },
    });
  }
