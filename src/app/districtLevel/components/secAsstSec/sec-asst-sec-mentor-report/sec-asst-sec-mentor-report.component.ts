...
export class SecAsstSecMentorReportComponent implements OnInit {
  ...
  onMentorChange(result): void {
    this.router.navigate(['/district/SecAsstSecRbkReport'], {
      queryParams: { request: result },
    });
  }

  onAsstSecChange(result): void {
    this.router.navigate(['/district/SecAsstSecDetailReport'], {
      queryParams: { request: result },
    });
  }

  onDetailsChange(result): void {
    this.router.navigate(['/district/SecAsstSecNotAddedDetailReport'], {
      queryParams: { request: result },
    });
  }
