...
export class LdmbankWiseRbkReportComponent implements OnInit {
  ...
  onPendingChange(result): void {
    this.router.navigate(['/district/LdmbankWisePendingReport'], {
      queryParams: { request: result },
    });
  }

  onApprovedRejectedChange(result): void {
    this.router.navigate(['/district/LdmbankWiseApprovedRejectedReport'], {
      queryParams: { request: result },
    });
  }
  ...
  btnBack(): void {
    ...
    this.router.navigate(['/district/LdmbankWiseBranchReport'], {
      queryParams: { request: result },
    });
  }
}
