...
@Component({
  selector: 'app-villagemeeting-building-ins-report',
  templateUrl: './villagemeeting-building-ins-report.component.html',
  styleUrls: ['./villagemeeting-building-ins-report.component.css'],
})
