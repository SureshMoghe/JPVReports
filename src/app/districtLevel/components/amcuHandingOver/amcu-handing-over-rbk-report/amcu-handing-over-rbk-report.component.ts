...
export class AmcuHandingOverRbkReportComponent implements OnInit {
  ...
  onRbkChange(result): void {
    this.router.navigate(['/district/AmcuHandingOverDetailReport'], {
      queryParams: { request: result },
    });
  }

  onVillageChange(result): void {
    this.router.navigate(['/district/AmcuHoNotSubmittedVillagesReport'], {
      queryParams: { request: result },
    });
  }
  ...
  btnBack(): void {
    ...
    this.router.navigate(['/district/AmcuHandingOverMentorReport'], {
      queryParams: { request: result },
    });
  }
}
