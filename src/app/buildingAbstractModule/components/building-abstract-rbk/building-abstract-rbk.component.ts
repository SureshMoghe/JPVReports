...
@Component({
  selector: 'app-building-abstract-rbk',
  templateUrl: './building-abstract-rbk.component.html',
  styleUrls: ['./building-abstract-rbk.component.css'],
})
export class BuildingAbstractRbkComponent
  ...
  async loadReport(): Promise<void> {
    try {
      ...
      this.spinner.show();
      const res = await this.buildingAbstract.rbkLevelAbstractReport(req);
      if (res.success) {
        this.excelData = [];
        ...
        for (let i = 0; i < this.rbkLevelDetails.length; i++) {
          ...
          this.reportTotals.IS_AMCU_BUILDING_GOVERNMENT += parseInt(
            this.rbkLevelDetails[i].IS_AMCU_BUILDING_GOVERNMENT
          );
          // tslint:disable-next-line: radix
          this.reportTotals.IS_AMCU_BUILDING_PRIVATE += parseInt(
            this.rbkLevelDetails[i].IS_AMCU_BUILDING_PRIVATE
          );
          // tslint:disable-next-line: radix
          this.reportTotals.IS_VILLAGE_LOC_IN_CENTERLY += parseInt(
            this.rbkLevelDetails[i].IS_VILLAGE_LOC_IN_CENTERLY
          );
          // tslint:disable-next-line: radix
          this.reportTotals.IS_VILLAGE_LOC_NOT_IN_CENTERLY += parseInt(
            this.rbkLevelDetails[i].IS_VILLAGE_LOC_NOT_IN_CENTERLY
          );
          // tslint:disable-next-line: radix
          this.reportTotals.IS_SAFETY_ARRANGEMENTS += parseInt(
            this.rbkLevelDetails[i].IS_SAFETY_ARRANGEMENTS
          );
          // tslint:disable-next-line: radix
          this.reportTotals.IS_NOT_SAFETY_ARRANGEMENTS += parseInt(
            this.rbkLevelDetails[i].IS_NOT_SAFETY_ARRANGEMENTS
          );
          // tslint:disable-next-line: radix
          this.reportTotals.IS_AVIL_ELECTRIC_CONC_1_PHASE += parseInt(
            this.rbkLevelDetails[i].IS_AVIL_ELECTRIC_CONC_1_PHASE
          );
          // tslint:disable-next-line: radix
          this.reportTotals.IS_AVIL_ELECTRIC_CONC_2_PHASE += parseInt(
            this.rbkLevelDetails[i].IS_AVIL_ELECTRIC_CONC_2_PHASE
          );
          // tslint:disable-next-line: radix
          this.reportTotals.IS_NOT_AVIL_ELECTRICCONNECTION += parseInt(
            this.rbkLevelDetails[i].IS_NOT_AVIL_ELECTRICCONNECTION
          );
          // tslint:disable-next-line: radix
          this.reportTotals.IS_AVIL_ELECTRIC_EARTHING += parseInt(
            this.rbkLevelDetails[i].IS_AVIL_ELECTRIC_EARTHING
          );
          // tslint:disable-next-line: radix
          this.reportTotals.IS_NOT_AVIL_ELECTRIC_EARTHING += parseInt(
            this.rbkLevelDetails[i].IS_NOT_AVIL_ELECTRIC_EARTHING
          );
          // tslint:disable-next-line: radix
          this.reportTotals.IS_AVIL_SPACE_VEHI_MOVMENT += parseInt(
            this.rbkLevelDetails[i].IS_AVIL_SPACE_VEHI_MOVMENT
          );
          // tslint:disable-next-line: radix
          this.reportTotals.IS_NOT_AVIL_SPACE_VEHI_MOVMENT += parseInt(
            this.rbkLevelDetails[i].IS_NOT_AVIL_SPACE_VEHI_MOVMENT
          );
          // tslint:disable-next-line: radix
          this.reportTotals.IS_AVIL_ROAD_TO_APPROCH_AMCU += parseInt(
            this.rbkLevelDetails[i].IS_AVIL_ROAD_TO_APPROCH_AMCU
          );
          // tslint:disable-next-line: radix
          this.reportTotals.ISNOT_AVIL_ROADTO_APPROCH_AMCU += parseInt(
            this.rbkLevelDetails[i].ISNOT_AVIL_ROADTO_APPROCH_AMCU
          );
          // tslint:disable-next-line: radix
          this.reportTotals.IS_HAVING_NETWORK_CONNECT += parseInt(
            this.rbkLevelDetails[i].IS_HAVING_NETWORK_CONNECT
          );
          // tslint:disable-next-line: radix
          this.reportTotals.ISNOT_HAVING_NETWORK_CONNECT += parseInt(
            this.rbkLevelDetails[i].ISNOT_HAVING_NETWORK_CONNECT
          );
          let singleRow = {
            S_NO: i + 1,
            RBK: this.rbkLevelDetails[i].RBK_NAME,
            ...
            IS_AMCU_BUILDING_GOVERNMENT: this.rbkLevelDetails[i]
              .IS_AMCU_BUILDING_GOVERNMENT,
            IS_AMCU_BUILDING_PRIVATE: this.rbkLevelDetails[i]
              .IS_AMCU_BUILDING_PRIVATE,
            IS_VILLAGE_LOC_IN_CENTERLY: this.rbkLevelDetails[i]
              .IS_VILLAGE_LOC_IN_CENTERLY,
            IS_VILLAGE_LOC_NOT_IN_CENTERLY: this.rbkLevelDetails[i]
              .IS_VILLAGE_LOC_NOT_IN_CENTERLY,
            IS_SAFETY_ARRANGEMENTS: this.rbkLevelDetails[i]
              .IS_SAFETY_ARRANGEMENTS,
            IS_NOT_SAFETY_ARRANGEMENTS: this.rbkLevelDetails[i]
              .IS_NOT_SAFETY_ARRANGEMENTS,
            IS_AVIL_ELECTRIC_CONC_1_PHASE: this.rbkLevelDetails[i]
              .IS_AVIL_ELECTRIC_CONC_1_PHASE,
            IS_AVIL_ELECTRIC_CONC_2_PHASE: this.rbkLevelDetails[i]
              .IS_AVIL_ELECTRIC_CONC_2_PHASE,
            IS_NOT_AVIL_ELECTRICCONNECTION: this.rbkLevelDetails[i]
              .IS_NOT_AVIL_ELECTRICCONNECTION,
            IS_AVIL_ELECTRIC_EARTHING: this.rbkLevelDetails[i]
              .IS_AVIL_ELECTRIC_EARTHING,
            IS_NOT_AVIL_ELECTRIC_EARTHING: this.rbkLevelDetails[i]
              .IS_NOT_AVIL_ELECTRIC_EARTHING,
            IS_AVIL_SPACE_VEHI_MOVMENT: this.rbkLevelDetails[i]
              .IS_AVIL_SPACE_VEHI_MOVMENT,
            IS_NOT_AVIL_SPACE_VEHI_MOVMENT: this.rbkLevelDetails[i]
              .IS_NOT_AVIL_SPACE_VEHI_MOVMENT,
            IS_AVIL_ROAD_TO_APPROCH_AMCU: this.rbkLevelDetails[i]
              .IS_AVIL_ROAD_TO_APPROCH_AMCU,
            ISNOT_AVIL_ROADTO_APPROCH_AMCU: this.rbkLevelDetails[i]
              .ISNOT_AVIL_ROADTO_APPROCH_AMCU,
            IS_HAVING_NETWORK_CONNECT: this.rbkLevelDetails[i]
              .IS_HAVING_NETWORK_CONNECT,
            ISNOT_HAVING_NETWORK_CONNECT: this.rbkLevelDetails[i]
  ...
  btnExcel(): void {
    this.utils.JSONToCSVConvertor(
      this.excelData,
      'Building Abstract RBK Level Report',
      true
    );
  }
  ...
  async btnPDF(): Promise<void> {
    try {
      ...
      const fileName = 'rbkLevelBuildingAbstractReport';
      let basePDF = '';
      this.spinner.show();
      const res = await this.buildingAbstract.rbkLevelAbstractPDFReport(req);
      if (res.success) {
        basePDF = res.result;
