...
@Component({
  selector: 'app-promoters-not-added-rbk',
  templateUrl: './promoters-not-added-rbk.component.html',
  styleUrls: ['./promoters-not-added-rbk.component.css'],
})
export class PromotersNotAddedRBKComponent
  implements OnInit, OnDestroy, AfterViewInit
{
  ...
  btnExcel(): void {
    this.utils.JSONToCSVConvertor(
      this.excelData,
      'Promoters Not Added RBKS Report',
      true
    );
  }
  ...
  async btnPDF(): Promise<void> {
    try {
      ...
      const fileName = 'PromotersNotAddedRBKSReport';
      let basePDF = '';
      this.spinner.show();
